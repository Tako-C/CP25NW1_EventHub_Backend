...
public class AdminService {
    ...
    public AdminCreateUserResponseDto createUserByAdmin(AdminCreateUserRequestDto request, String adminEmail) {
        ...
        boolean isAutoGeneratedPassword = true;
    ...
    public Map<String, Object> addUserToEvent(Integer eventId, AdminAddUserToEventRequestDto request) {
        ...
        String qrCodeUrl = eventRegistrationService.registerUserForEvent(user, event);
        MemberEvent memberEvent = memberEventRepository.findByUserIdAndEventId(user.getId(), event.getId())
                .orElseThrow(() -> new ResourceNotFoundException("MemberEvent not found after registration"));
