...
public class AuthService {
    ...
    public User registerWithOtp(RegisterOtpVerifyRequestDto request, boolean isAutoGeneratedPassword) {
        ...
        User savedUser = createUser(otpData.getFirstName(), otpData.getLastName(), email, encodedPassword,
                otpData.getDateOfBirth(), otpData.getGender());

        return savedUser;
    }

    public void sendWelcomeEmailAfterRegistration(User user, String rawPassword, boolean isAutoGeneratedPassword) {
        try {
            if (isAutoGeneratedPassword) {
                emailService.sendWelcomeEmail(user.getEmail(), user.getFirstName(), rawPassword);
            } else {
    ...
    private User createUser(String firstName, String lastName, String email, String encodedPassword,
        ...
        user.setGender(gender != null ? gender : "N");
