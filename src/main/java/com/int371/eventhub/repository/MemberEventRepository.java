...
public interface MemberEventRepository extends JpaRepository<MemberEvent, Integer> {
        ...
        List<MemberEvent> findByEventStatusAndSendEmailIn(EventStatus status, List<Integer> sendEmail,
                        Pageable pageable);
        ...
        List<Object[]> countAgeRangesByEventIdAndStatuses(@Param("eventId") Integer eventId,
        ...
        List<Object[]> countGendersByEventIdAndStatuses(@Param("eventId") Integer eventId,
                        @Param("statuses") List<String> statuses);
        ...
        List<Object[]> countJobsByEventIdAndStatuses(@Param("eventId") Integer eventId,
                        @Param("statuses") List<String> statuses);
        ...
        @Query(value = "SELECT " +
                        ...
                        "GROUP BY c.NAME_TH " +
                        "ORDER BY TOTAL_PARTICIPANTS DESC", nativeQuery = true)
        List<Object[]> countCitiesByEventIdAndStatuses(@Param("eventId") Integer eventId,
                        @Param("statuses") List<String> statuses);
        ...
        @Query(value = "SELECT " +
                        ...
                        "ORDER BY TOTAL_PARTICIPANTS DESC", nativeQuery = true)
        List<Object[]> countRolesByEventIdAndStatuses(@Param("eventId") Integer eventId,
                        @Param("statuses") List<String> statuses);
        ...
        Long countByEventIdAndEventRoleAndDonePreSurvey(Integer eventId, MemberEventRole eventRole,
                        Integer donePreSurvey);
        ...
        Long countParticipantPreSurvey(@Param("eventId") Integer eventId,
                        @Param("donePreSurvey") Integer donePreSurvey);

        @Query("SELECT COUNT(me) FROM MemberEvent me WHERE me.event.id = :eventId " +
                        "AND me.eventRole IN (com.int371.eventhub.entity.MemberEventRole.VISITOR, com.int371.eventhub.entity.MemberEventRole.EXHIBITOR) "
                        +
                        "AND me.donePostSurvey = :donePostSurvey")
        Long countParticipantPostSurvey(@Param("eventId") Integer eventId,
        ...
        Long countParticipantBothSurveys(@Param("eventId") Integer eventId,
                        @Param("donePreSurvey") Integer donePreSurvey,
                        @Param("donePostSurvey") Integer donePostSurvey);
        ...
        List<com.int371.eventhub.dto.SurveyStatusListDto> findSurveyStatusByEventIdAndRole(
                        @Param("eventId") Integer eventId,
                        @Param("role") MemberEventRole role);

        List<MemberEvent> findAllByUserId(Integer userId);
